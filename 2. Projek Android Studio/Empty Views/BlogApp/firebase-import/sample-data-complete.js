...
const sampleBlogs = [
  ...
  },
  {
    ...
    imageUrl: '',
    categoryId: 'cat-1',
    tags: ['firebase', 'programming', 'tutorial'],
    viewCount: 89,
    likeCount: 19,
  },
  {
  ...
  },
  {
    ...
    content:
      'Gudeg adalah makanan khas Yogyakarta yang terbuat dari nangka muda. Cara membuatnya: 1) Rebus nangka muda dengan santan, 2) Tambahkan bumbu halus (bawang merah, putih, kemiri, ketumbar), 3) Masak dengan api kecil selama 3-4 jam, 4) Sajikan dengan nasi, ayam, telur, dan sambal krecek.',
  ...
  },
  {
    ...
    content:
      'Perjalanan menjadi entrepreneur tidaklah mudah. Dimulai dari ide sederhana, modal pas-pasan, hingga menghadapi berbagai tantangan. Yang terpenting adalah konsistensi, pantang menyerah, dan terus belajar dari setiap kegagalan. Setiap masalah adalah kesempatan untuk berkembang.',
  ...
  },
  {
    ...
    content:
      'Langkah-langkah setup environment Android development: 1) Install Android Studio, 2) Setup Android SDK, 3) Configure emulator atau physical device, 4) Install Git untuk version control, 5) Setup Firebase project, 6) Configure Gradle dan dependencies yang diperlukan.',
    authorId: 'user-demo-3',
    authorName: 'developer@tech.com',
    timestamp: Date.now() - 4 * 60 * 60 * 1000, // 4 hours ago
    imageUrl: '',
    categoryId: 'cat-1',
    tags: ['android', 'programming', 'tutorial'],
    viewCount: 98,
    likeCount: 21,
  },
  {
    ...
    content:
      'Traveling ke Bali dengan budget terbatas bisa dilakukan dengan tips berikut: 1) Pilih homestay atau guesthouse, 2) Makan di warung lokal, 3) Gunakan transportasi umum atau sewa motor, 4) Kunjungi tempat wisata gratis seperti pantai dan pura, 5) Beli oleh-oleh di pasar tradisional.',
    authorId: 'user-demo-5',
    authorName: 'foodie@culinary.com',
  ...
  },
  {
    ...
    content:
      'Meditasi bukan hanya untuk relaksasi, tetapi juga meningkatkan produktivitas. Manfaat meditasi: 1) Meningkatkan fokus dan konsentrasi, 2) Mengurangi stress dan anxiety, 3) Meningkatkan kreativitas, 4) Memperbaiki kualitas tidur, 5) Meningkatkan emotional intelligence.',
    authorId: 'user-demo-4',
    authorName: 'writer@stories.com',
  ...
  },
  {
    ...
    content:
      'Keamanan Firebase Firestore sangat penting. Best practices: 1) Jangan gunakan test mode di production, 2) Implement authentication terlebih dahulu, 3) Gunakan resource-based rules, 4) Validate data dengan schema, 5) Test security rules secara menyeluruh, 6) Monitor activity logs.',
    authorId: 'user-demo-1',
    authorName: 'demo@blogapp.com',
    timestamp: Date.now() - 30 * 60 * 1000, // 30 minutes ago
    imageUrl: '',
    categoryId: 'cat-1',
    tags: ['firebase', 'programming'],
    viewCount: 112,
    likeCount: 25,
  },
];
...
module.exports = { sampleBlogs, sampleUsers, sampleCategories, sampleComments, sampleTags };
